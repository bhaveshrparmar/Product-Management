...
exports.updateSubCategory = async (req, res) => {
  ...
  const subCategory = await updateModel(SubCategory, id, { category_id, sub_name }, "SubCategory Updated...")
  res.json({
    subCategory
  })
}
exports.trashSubCategory = async (req, res) => {
  const { id } = req.params
  const subCategory = await trashModel(SubCategory, id, "SubCategory Deleted...")
  res.json({
    subCategory
  })
}
